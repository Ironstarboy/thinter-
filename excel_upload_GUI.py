...
window = tk.Tk()
window.title('excel上传')  # 标题
window.geometry('500x500')  # 窗口尺寸
l = tk.Label(window, text='请上传文件', bg='green', font=('Arial', 12), width=30, height=2)
...
# bt1.pack()
bt2 = tk.Button(window, text='上传文件', width=15, height=2, command=save_file)
bt2.pack()
